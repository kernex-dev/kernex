...
- *(memory)* atomic task claims + task_runs execution history ([#61](https://github.com/kernex-dev/kernex/pull/61))
- *(core,providers,runtime)* stop the agentic loop at a token budget ([#59](https://github.com/kernex-dev/kernex/pull/59))

## [0.8.1](https://github.com/kernex-dev/kernex/compare/v0.8.0...v0.8.1) - 2026-05-12

### Other

- *(opsec)* scrub internal planning identifiers + archive completed change ([#24](https://github.com/kernex-dev/kernex/pull/24))
